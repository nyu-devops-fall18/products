...
BASE_URL = getenv('BASE_URL', 'https://nyu-product-service-f18.mybluemix.net/')
WAIT_SECONDS = 20
# count = 0
...
def step_impl(context):
    ...
    # global count
    # get_url = context.base_url + '/products'
    # normal_resp = requests.get(get_url)
    # # print(normal_resp.text)
